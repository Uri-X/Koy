...
// Customer dashboard (PRD 6.3): real star balance, progress, and a
// working redeem action, pulled live from the API.
// No auth yet, so the customer identifies themselves by phone (same
// lookup pattern as the merchant's transaction-logging screen).
